...
class GraphicTracker<T> extends Tracker<T> {
    ...
    public void onUpdate(Detector.Detections<T> detectionResults, T item) {
        ...
        Log.d("FD", "ITEMMMM:" + itemd.getValue());
        */

        /*
        SparseArray<Barcode> items = (SparseArray<Barcode>) detectionResults.getDetectedItems();
        Barcode thisCode = items.valueAt(0);
        Log.d("FD", "ITEMMMM:" + thisCode.rawValue);
        */
    }
