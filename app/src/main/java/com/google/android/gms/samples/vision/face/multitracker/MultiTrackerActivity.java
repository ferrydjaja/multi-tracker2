...
public final class MultiTrackerActivity extends AppCompatActivity implements GraphicTracker.BarcodeUpdateListener {
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        Log.d("FD", "onTAP:" + BarcodeValue + "||" + TextValue);
        ...
        if((BarcodeValue != null && TextValue != null) && (BarcodeValue != "" && TextValue != "")) {
            ...
            stringBuilder.append(BarcodeValue);
    ...
    public void onBarcodeDetected(Detector.Detections detectionResults, boolean flag) {
        ...
        if(flag) { //TextBlock
            ...
            Log.d("FD", "OCR:" + stringBuilder.toString());
            ...
            while (!stopThread) {
                try {
                    ...
                    if((BarcodeValue != null && TextValue != null) && (BarcodeValue != "" && TextValue != "")) {
                        ...
                        //Log.d("FD", "Result:" + BarcodeValue + " || " + TextValue);
                        stopThread = true;
                        Thread.interrupted();
                        ...
                        Snackbar.make(mGraphicOverlay, BarcodeValue + ":" + TextValue, Snackbar.LENGTH_LONG).show();
                        BarcodeValue = null;
                        TextValue = null;
